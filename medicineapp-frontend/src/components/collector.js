...
// // import '../components/collector.css'
...
//                 <button type="button" class="btn btn-primary col-lg-1 mr-2" onClick={handleAddData}>Add</button>
//                     {/* <label>Add Prescription</label> */}
//                     {/* <input type='file' onChange={fileAddHandler}/> */}
